...
```{r CURSO-53, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Clasificar un texto como positivo, negativo o neutral."}
...
```{r CURSO-54, echo=FALSE, out.width="60%", fig.align='center',fig.cap=". Clasificar un texto con tres emociones."}
knitr::include_graphics("FIG54.jpg")
```
...
```{r CURSO-55, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Ejemplo de extracción de entidades."}
...
```{r CURSO-56, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Ejemplo de extracción de entidades con pocos disparos."}
knitr::include_graphics("FIG56.jpg")
```



```{r CURSO-56B,echo=FALSE, results='asis'}
cat('
