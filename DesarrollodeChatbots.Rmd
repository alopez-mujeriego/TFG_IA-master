...
```{r CURSO-61, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Usar tanto el rol del usuario como el rol del sistema."}
knitr::include_graphics("FIG61.jpg")
```




```{r CURSO-61B,echo=FALSE, results='asis'}
cat('
...
```{r CURSO-62, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Usar tanto el rol del usuario como el rol del sistema dándole más información de comportamiento."}
knitr::include_graphics("FIG62.jpg")
```



```{r CURSO-62B,echo=FALSE, results='asis'}
cat('
<div style="text-align: center;">
...
```{r CURSO-63, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Usar tanto el rol del usuario como el rol del sistema dándole más información de comportamiento en formato condicional."}
knitr::include_graphics("FIG63.jpg")
```
...
```{r CURSO-63B,echo=FALSE, results='asis'}
cat('
<div style="text-align: center;">
