...
```{r CURSO-66, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Ejemplo de incorporación de contexto externo."}
knitr::include_graphics("FIG66.jpg")
```




```{r CURSO-66B,echo=FALSE, results='asis'}
cat('
...
```{r CURSO-67, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Ejemplo de incorporación de contexto externo de muestra."}
knitr::include_graphics("FIG67.jpg")
```
...
```{r CURSO-67B,echo=FALSE, results='asis'}
cat('
<div style="text-align: center;">
