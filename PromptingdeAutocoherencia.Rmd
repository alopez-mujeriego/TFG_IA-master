...
```{r CURSO-37, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Aplicación 2: Usuario/(Sistema o Asistente)."}
...
```{r CURSO-38, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Resolver el problema del auto alimentando el Sistema de Prompt."}
knitr::include_graphics("FIG38.jpg")
```
...
```{r CURSO-39, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Proceso iterativo y refinamiento del prompt."}
knitr::include_graphics("FIG39.jpg")
```
...
```{r CURSO-39B,echo=FALSE, results='asis'}
cat('
