...
```{r CURSO-18, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Mejorando las respuestas utilizando verbos apropiados."}
...
```{r CURSO-19, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Mejorando las respuestas utilizando descripciones más precisas."}
...
```{r CURSO-20, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Especificando en el prompt que el texto a resumir está delimitado."}
knitr::include_graphics("FIG24.jpg")
```



```{r CURSO-20B,echo=FALSE, results='asis'}
cat('
