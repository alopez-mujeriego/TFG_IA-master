...
```{r CURSO-30, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Ejemplo de prompting con varios disparos. (Hecho con Python)"}
knitr::include_graphics("FIG30.jpg")
```
...
```{r CURSO-31, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Ejemplo de prompting con cero disparos."}
...
```{r CURSO-32, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Ejemplo de prompting con un disparo."}
...
```{r CURSO-33, echo=FALSE, out.width="60%", fig.align='center',fig.cap="Ejemplo de prompting varios disparos."}
...
```{r CURSO-33B,echo=FALSE, results='asis'}
cat('
